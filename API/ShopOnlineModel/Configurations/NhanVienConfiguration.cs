...
namespace ShopOnlineModel.Configurations
{
	internal class NhanVienConfiguration : IEntityTypeConfiguration<NhanVien>
	{
		public void Configure(EntityTypeBuilder<NhanVien> builder)
		{
			...
			builder.HasData(new NhanVien() { ID = new Guid("2EC27AB7-5F67-4ED5-AE67-52F9C9726EBF"), Ten = "Admin", Email = "tamncph25588@fpt.edu.vn", SDT = "0988143310", DiaChi = "Ha Noi", TrangThai = 1, IDVaiTro = new Guid("B4996B2D-A343-434B-BFE9-09F8EFBB3852"), PassWord = "$2a$10$SkimxxBIlrv/l33hTFvbkutV/.jF4rlwd9APgp1ZZjNEgVDYXvHa6" });
		}
	}
}
